...
import com.example.list.ProductsSpringApplication;
...
public class ProductsController {
    ...
    public String getAll() {
        return productsSpringApplication.getAll();
    }

    @GetMapping("/id/{id}")
    public String getById(@PathVariable int id) {
        return productsSpringApplication.getById(id);
    }

    @GetMapping("{id}")
    public String getByPram(@PathVariable int id) {
        return productsSpringApplication.getByParam(id);
    }
}
